 ...
 */
final class Version20230731093048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_commande ADD img VARCHAR(255) NOT NULL COLLATE `utf8_general_ci`');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detail_commande DROP img');
