 ...
 */
final class Version20230625105345 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE tel tel VARCHAR(14) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE tel tel VARCHAR(12) DEFAULT NULL');
    }
}
